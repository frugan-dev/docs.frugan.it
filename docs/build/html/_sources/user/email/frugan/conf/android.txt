...
.. image:: /assets/img/email/frugan/conf/android/inserimento_e-mail_e_password.png
...
| **IMAP Server** (Server IMAP): imap.frugan.it
| **Security Type** (Tipo di sicurezza): SSL
| **Server port** (Porta): 993.

Quindi fai clic su **Next** (Avanti).

.. image:: /assets/img/email/frugan/conf/android/impostazioni_server_entrata.png
...
| **Password**: la password per l’indirizzo e-mail indicato in alto
| **SMTP server** (Server SMTP): smtp.frugan.it
| **Security Type**: SSL
| **Server port**: 465

Quindi fai clic su **Next** (Avanti).

.. image:: /assets/img/email/frugan/conf/android/impostazioni_server_uscita.png
...
.. image:: /assets/img/email/frugan/conf/android/configurazione_account_effettuata.png