...
.. image:: /assets/img/email/frugan/conf/mail_osx/preferenze_mail_osx.png
...
.. image:: /assets/img/email/frugan/conf/mail_osx/clic_icona_piu_osx.png
...
.. image:: /assets/img/email/frugan/conf/mail_osx/benvenuto_mail_osx.png
...
| Nel campo **Incoming Mail Server**, digita **imap.frugan.it**.
| Inserisci il tuo indirizzo e-mail nel campo **User Name** e la tua password nel campo **password**.
| Fai clic su **Continue**.

.. image:: /assets/img/email/frugan/conf/mail_osx/server_posta_entrata_osx.png
	
Seleziona **Use Secure Sockets Layer (SSL)** e seleziona **Password**in nel menu a discesa **Authentication**. Fai clic su **Continue**.

.. image:: /assets/img/email/frugan/conf/mail_osx/protezione_posta_entrata_osx.png
	
| Inserisci una descrizione nel campo **Description**, che ti permetterà di riconoscere l’account.
| Nel campo **Outgoing Mail Server**, inserisci **smtp.frugan.it**. Verifica che l’opzione **Use only this server** sia selezionata.
...
.. image:: /assets/img/email/frugan/conf/mail_osx/server_posta_uscita_osx.png
...
.. image:: /assets/img/email/frugan/conf/mail_osx/riepilogo_account_osx.png
	
Torna alla schermata **Accounts** facendo clic su **Mail**, **Preferences**, **Accounts**.

.. image:: /assets/img/email/frugan/conf/mail_osx/informazioni_avanzate_account_osx.png
	
Dal menu a discesa **Outgoing Mail Server (SMTP)**, seleziona **Edit SMTP Server List**.

.. image:: /assets/img/email/frugan/conf/mail_osx/elenco_server_smtp_modifica_osx.png

| Verifica che l’opzione **Server Name** smtp.frugan.it sia selezionata e fai clic sulla scheda **Advanced**. Seleziona **Use custom port** e inserisci **465**.
...
.. image:: /assets/img/email/frugan/conf/mail_osx/informazioni_account_osx.png
