...
.. attention, caution (Attenzione), danger, error, hint (Consiglio), important, note, tip, warning, admonition, title
.. attention:: A prescindere dal dominio utilizzato, l'accesso ai server di posta `EWake <https://ewake.it>`_ avviene sempre tramite hostname del tipo `*.ewake.it`.
